(function($){
	var ocfilter = {
	  ...
	  update: function() {
		  ...
		  $.get('index0f83.html?route=module/ocfilter/callback', data, function(json){
				/* Start update */
	  ...
	  preload: function() {
	    ...
	    this.options.element.floatButton.css('top', target.offset().top - this.offset.top - (this.options.element.floatButton.height() - target.height()) / 2);
		},
